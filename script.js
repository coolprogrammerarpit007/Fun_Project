...
function clearAll() {
let memeContainer = document.querySelector('.meme-content');
let jokeContainer = document.querySelector('.joke-content');
let wisdomContainer = document.querySelector('.wisdom-content');
...
function showJoke() {
  ...
  clearAll();
  jokeContainer.append(newParagraph); 
...
function showQuote() {
  ...
  clearAll();
  quoteContainer.append(newQuote,newAuthor);
...
function showRiddle() {
  ...
  clearAll();
  riddleContainer.append(newRiddle,newAnswer);
}
...
function revealAnswers() {
  ...
  if(riddle && answer){
    ...
    alert('Answer is already there!');
  }
  else{
    alert("There is no riddle here! at all DON'T BREAK MY CODE! Okay :)");
  }
}
